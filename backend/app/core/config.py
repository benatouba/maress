...
class Settings(BaseSettings):
    ...
    GEOCODING_STRICT_LOW_SIGNAL_SECTION_MIN_CONFIDENCE: float = 0.93
    GEOCODING_REQUIRE_CONTEXT_CUE_FOR_LOW_SIGNAL_SECTION: bool = True
    GEOCODING_MIN_TOP_CANDIDATE_SCORE: float = 0.95
    GEOCODING_AMBIGUITY_SCORE_MARGIN: float = 0.45
    GEOCODING_AMBIGUITY_DISTANCE_KM: float = 200.0
