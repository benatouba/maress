...
import { mockStudySite, mockStudySiteAuto, mockItem } from '../mocks/api-mocks';
// Mock API
...
describe('Study Sites CRUD Integration Tests', () => {
    ...
    describe('Error Handling in CRUD Operations', () => {
        it('should handle CREATE error gracefully', async () => {
            ...
            expect(notificationStore.showNotification).toHaveBeenCalledWith(expect.stringContaining('Failed'), 'error');
        });
