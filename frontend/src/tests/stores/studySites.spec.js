...
import { mockStudySite, mockStudySiteAuto, mockItem, mockItemsResponse, mockStudySitesResponse } from '../mocks/api-mocks';
...
describe('StudySites Store', () => {
    ...
    describe('fetchItemStudySites', () => {
        ...
        it('should handle errors when fetching item study sites', async () => {
            ...
            expect(notificationStore.showNotification).toHaveBeenCalledWith('Failed to fetch study sites', 'error');
        });
    ...
    describe('createStudySite', () => {
        ...
        it('should create a new study site', async () => {
            ...
            expect(mockPost).toHaveBeenCalledWith('/study-sites/items/item-1/study-sites', newSiteData);
            expect(result).toEqual(createdSite);
            expect(store.studySites).toHaveLength(1);
            expect(notificationStore.showNotification).toHaveBeenCalledWith('Study site created successfully', 'success');
        });
        ...
        it('should handle creation errors', async () => {
            ...
            expect(notificationStore.showNotification).toHaveBeenCalledWith('Failed to create study site', 'error');
        });
    });
    describe('updateStudySite', () => {
        ...
        it('should update an existing study site', async () => {
            ...
            expect(mockPut).toHaveBeenCalledWith('/study-sites/study-sites/site-1', updateData);
            expect(result).toEqual(updatedSite);
            expect(notificationStore.showNotification).toHaveBeenCalledWith('Study site updated successfully', 'success');
        });
        ...
        it('should handle update errors', async () => {
            ...
            const result = await store.updateStudySite('site-1', updateData);
            expect(result).toBeNull();
            expect(notificationStore.showNotification).toHaveBeenCalledWith('Failed to update study site', 'error');
        });
    });
    describe('deleteStudySite', () => {
        ...
        it('should delete a study site', async () => {
            ...
            expect(notificationStore.showNotification).toHaveBeenCalledWith('Study site deleted successfully', 'success');
        });
        ...
        it('should handle deletion errors', async () => {
            ...
            expect(notificationStore.showNotification).toHaveBeenCalledWith('Failed to delete study site', 'error');
        });
    });
