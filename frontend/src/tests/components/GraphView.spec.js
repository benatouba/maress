...
describe('GraphView.vue', () => {
    ...
    describe('Graph Data Building', () => {
        ...
        it('should create tag nodes', () => {
            ...
            const graphData = wrapper.vm.buildGraphData;
            const tagNodes = graphData.nodes.filter((n) => n.data.type === 'tag');
        ...
        it('should create item nodes', () => {
            ...
            const graphData = wrapper.vm.buildGraphData;
            const itemNodes = graphData.nodes.filter((n) => n.data.type === 'item');
        ...
        it('should warn when dataset is too large', () => {
            ...
            expect(consoleSpy).toHaveBeenCalledWith(expect.stringContaining('Dataset too large'));
    ...
    describe('Graph Controls', () => {
        it('should fit graph on fit button click', async () => {
            ...
            await flushPromises();
            const fitBtn = wrapper.findAll('.control-btn').find(btn => btn.text().includes('Fit'));
        ...
        it('should center graph on center button click', async () => {
            ...
            await flushPromises();
            const centerBtn = wrapper.findAll('.control-btn').find(btn => btn.text().includes('Center'));
        ...
        it('should export graph on export button click', async () => {
            ...
            await flushPromises();
            const exportBtn = wrapper.findAll('.control-btn').find(btn => btn.text().includes('Export'));
