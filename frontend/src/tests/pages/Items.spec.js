...
describe('Items Page', () => {
    ...
    describe('Sync Functionality', () => {
        ...
        it('should sync library on button click', async () => {
            ...
            expect(notificationStore.showNotification).toHaveBeenCalledWith('Library synced successfully', 'success');
        });
    ...
    describe('Refresh Functionality', () => {
        it('should refresh items on button click', async () => {
            ...
            await flushPromises();
            expect(zoteroStore.fetchItems).toHaveBeenCalled();
            expect(notificationStore.showNotification).toHaveBeenCalledWith('Items refreshed', 'success');
        });
    });
    describe('Row Click', () => {
        beforeEach(async () => {
    ...
    describe('Extract Study Sites', () => {
        ...
        it('should show notification when extraction starts', async () => {
            ...
            expect(notificationStore.showNotification).toHaveBeenCalledWith('Study site extraction started', 'info');
        });
    });
    describe('Delete Item', () => {
        ...
        it('should show confirmation dialog', async () => {
            ...
            expect(global.confirm).toHaveBeenCalledWith(expect.stringContaining(mockItem.title));
        });
